...
class RWA {
	public:
		...
		static void DijkstraPSR(const int orN, const int deN, const int L, Def *Config, MAux *MainAux); /*Implementa o algoritmo de roteamento de Dijkstra para achar rotas entre quaisquer dois nós da rede, considerando coeficientes do PSR*/
		...
		static void DijkstraSPeFormas(const int orN, const int deN, const int L, float alfa, Def *Config, MAux *Aux); /*Implementa o algoritmo de roteamento Dijkstra com Shortest Path e Formas.*/
		static void DijkstraRuidoeFormas(const int orN, const int deN, const int L, float beta, EsquemaDeModulacao Esquema, long double TaxaDeTransmissao, Def *Config, MAux *Aux); /*Implementa o algoritmo de roteamento Dijkstra com Ruído do Enlace normalizado e Formas.*/
