...
class RWA {
	public:
		...
		static void DijkstraAcum(const int orN, const int deN, const int L, Def *Config); /*Implementa o algoritmo de roteamento de Dijkstra para achar rotas entre quaisquer dois nós da rede, considerando número de maneiras de alocar os slots no enlace como o custo do caminho*/
		static void DijkstraFormas(const int orN, const int deN, const int L, Def *Config); /*Implementa o algoritmo de roteamento de Dijkstra para achar rotas entre quaisquer dois nós da rede, considerando número de maneiras de alocar os slots no enlace e número de nós até o destino como o custo do caminho*/
		static void DijkstraPSR(const int orN, const int deN, const int L, Def *Config); /*Implementa o algoritmo de roteamento de Dijkstra para achar rotas entre quaisquer dois nós da rede, considerando coeficientes do PSR*/
		...
		static void DijkstraSPeFormas(const int orN, const int deN, const int L, float alfa, Def *Config); /*Implementa o algoritmo de roteamento Dijkstra com Shortest Path e Formas.*/
		...
		static void LORModificado(const int orN, const int deN, const int L, Def *Config);
