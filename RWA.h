...
class RWA {
	public:
		...
		static void DijkstraPSR(const int orN, const int deN, const int L, Def *Config, MAux *Aux); /*Implementa o algoritmo de roteamento de Dijkstra para achar rotas entre quaisquer dois nós da rede, considerando coeficientes do PSR*/
