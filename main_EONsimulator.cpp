...
void createStructures() {
    ...
    for ( orN = 0; orN < Def::getNnodes(); orN++ ) {
        for ( deN = 0; deN < Def::getNnodes(); deN++ ) {
            switch (MAux::escTop) {
                case PacificBell: MAux::Topol2 >> MAux::Topology[orN * Def::Nnodes + deN];
                    break;
                case NSFNet: MAux::Topol >> MAux::Topology[orN * Def::Nnodes + deN];
                    break;
                case NFSNetMod: MAux::Topol5 >> MAux::Topology[orN * Def::Nnodes + deN];
                    break;
                case PontoaPonto8: MAux::Topol3 >> MAux::Topology[orN * Def::Nnodes + deN];
                    break;
                case PontoaPonto4: MAux::Topol4 >> MAux::Topology[orN * Def::Nnodes + deN];
                    break;
                case Top1: MAux::Topol6 >> MAux::Topology[orN * Def::Nnodes + deN];
                    break;
                case Top2: MAux::Topol7 >> MAux::Topology[orN * Def::Nnodes + deN];
                    break;
                case Top3: MAux::Topol8 >> MAux::Topology[orN * Def::Nnodes + deN];
                    break;
            }
    ...
    switch (MAux::escTop) {
        case PacificBell: MAux::Topol2 >> multiplicador;
            break;
        case NSFNet: MAux::Topol>>multiplicador;
            break;
        case NFSNetMod: MAux::Topol5>>multiplicador;
            break;
        case PontoaPonto8: MAux::Topol3>>multiplicador;
            break;
        case PontoaPonto4: MAux::Topol4>>multiplicador;
            break;
        case Top1: MAux::Topol6>>multiplicador;
            break;
        case Top2: MAux::Topol7>>multiplicador;
            break;
    }
    ...
    for ( int i = 0; i < Def::getNnodes(); i++ ) {
        for ( int j = 0; j < Def::getNnodes(); j++ ) {
            ...
            switch (MAux::escTop) {
                case PacificBell: MAux::Topol2 >> distancia_temp;
                    break;
                case NSFNet: MAux::Topol>>distancia_temp;
                    break;
                case NFSNetMod: MAux::Topol5>>distancia_temp;
                    break;
                case PontoaPonto8: MAux::Topol3>>distancia_temp;
                    break;
                case PontoaPonto4: MAux::Topol4>>distancia_temp;
                    break;
                case Top1: MAux::Topol6>>distancia_temp;
                    break;
                case Top2: MAux::Topol7>>distancia_temp;
                    break;
                case Top3: MAux::Topol8>>distancia_temp;
                    break;
            }
...
void Load() {
    ...
    switch (MAux::escTop) {
        case PacificBell: MAux::Topol2 >> aux;
            break;
        case NSFNet: MAux::Topol>>aux;
            break;
        case NFSNetMod: MAux::Topol5>>aux;
            break;
        case PontoaPonto4: MAux::Topol4>>aux;
            break;
        case PontoaPonto8: MAux::Topol3>>aux;
            break;
        case Top1: MAux::Topol6>>aux;
            break;
        case Top2: MAux::Topol7>>aux;
            break;
        case Top3: MAux::Topol8>>aux;
            break;
    }
...
void RequestCon(Event* evt, Def *Config, MAux *MainAux) {
    ...
    if ( Aux->escTipoRede == Transparente ) {
            ...
            for ( unsigned int i = 0; i < MainAux->AllRoutes[orN * Def::getNnodes() + deN].size(); i++ ) {
                ...
                if ( NslotsUsed > 0 ) { //A conexao foi aceita
                    ...
                    if ( MAux::AvaliaOsnr == NAO || OSNR >= Def::getlimiarOSNR(evt->Esquema, Def::PossiveisTaxas[nTaxa]) ) { //aceita a conexao
                        ...
                        NslotsUsed = 0;
                        if ( Esq == numEsquemasDeModulacao - 1 ) { //Fim da linha em Redes Transparentes
    ...
    if ( MAux::escTipoRede == Translucida ) { //Nova Chance de estabelecer chamadas bloqueadas em Redes Translucidas
        route = MainAux->AllRoutes[orN * Def::getNnodes() + deN].at(0);
        NslotsReq = SlotsReq(Def::PossiveisTaxas[nTaxa], _4QAM);
        if ( MAux::escRA == FLR ) {
